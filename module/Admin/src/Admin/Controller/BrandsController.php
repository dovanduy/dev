...
use Admin\Form\Brand\SearchForm;
use Admin\Form\Brand\ListForm;
use Admin\Form\Brand\AddForm;
use Admin\Form\Brand\UpdateForm;
use Admin\Form\Brand\UpdateLocaleForm;
use Admin\Form\Brand\ImageForm;
    ...
    { 
        ...
        if ($request->isPost()) {
            ...
            if (!empty($post['sort'])) {  
                ...
                Api::call('url_brands_updatesort', $post); 
                if (empty(Api::error())) {
                    if ($request->isXmlHttpRequest()) {
                        echo 'OK';
                        exit;
        ...
        $listForm   ->setAttribute('sortable', true)
                    ->setController($this)
                    ->setDataset(Api::call('url_brands_lists', $param))
                    ->create();
