<?php
/*
   php /home/vuong761/public_html/shell/vuongquocbalo/facebook_share.php
 * 
 */
include ('base.php');
$auth = ['facebook_login3.serialize', 'facebook_login4.serialize', 'facebook_login5.serialize'];
...
$groups = app_array_rand(app_facebook_groups($AppUI->user_id), 10);
