...
$categoryId = 8;
$albumData = [
    'name' => 'Túi xách NỮ sành điệu, giá tốt nhất thị trường đang giảm giá đến 30% trên website vuongquocbalo.com, mua ngay kẻo hết',
    'message' => implode(PHP_EOL, [
        '✓ NT đặt hàng: MH1,MH2,MH3 gửi 098 65 60 997 (MH: mã hàng)',
        '✓ ĐT đặt hàng: 097 443 60 40 - 098 65 60 997',        
        '✓ Xem chi tiết và giá bán trong hình nhé các HOT GIRL',
